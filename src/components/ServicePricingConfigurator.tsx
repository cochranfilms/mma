            ...
            <div className="p-8">
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center px-6 py-4 rounded-xl bg-[#e0ab10] text-[#010043] font-bold text-lg shadow-[0_6px_20px_rgba(224,171,16,0.35)] hover:opacity-95"
                >
                  Pay Invoice Securely
                </a>
                <button
                  onClick={() => setShowModal(false)}
                  className="px-6 py-4 rounded-xl border border-gray-300 text-gray-800 font-medium hover:bg-gray-50"
                >
                  Not now
                </button>
              </div>
